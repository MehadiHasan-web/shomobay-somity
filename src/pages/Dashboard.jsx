            ...
            <div className="parent">
              <div className="card">
                <div className="logo">
                  ...
                  <span className="circle circle5"> <span className="text-black font-bold text-xl">{society?.liquidCash}</span>
                    <svg
                ...
                <div className="content">
                  <span className="title">Liquid Cash</span>
                  <span className="text">
            ...
            <div className="parent">
              <div className="card">
                <div className="logo">
                  ...
                  <span className="circle circle3" />
                  <span className="circle circle4" />
                  <span className="circle circle5"> <span className="text-black font-bold text-xl">{society?.totalAsset}</span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 29.667 31.69"
                      className="svg hidden"
                ...
                <div className="glass" />
                <div className="content">
                  <span className="title">Total Asset</span>
                  <span className="text">
                    Create, share, and use beautiful custom elements made with CSS
                  </span>
                </div>
            ...
            <div className="parent">
              <div className="card">
                <div className="logo">
                  ...
                  <span className="circle circle3" />
                  <span className="circle circle4" />
                  <span className="circle circle5"> <span className="text-black font-bold text-xl">{society?.totalLoanGiven}</span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 29.667 31.69"
                      className="svg hidden"
                ...
                <div className="glass" />
                <div className="content">
                  <span className="title">Total Loan Given</span>
                  <span className="text">
                    Create, share, and use beautiful custom elements made with CSS
                  </span>
                </div>
