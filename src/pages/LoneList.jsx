...
const LoneList = () => {
  ...
  useEffect(() => {
    ...
    if (searchText.trim() !== "") {
      ...
      filteredResults = filteredResults.filter(item =>
        ...
        item.details.toString().toLowerCase().includes(searchTextLower) ||
        // item.loanDateFrom.toString().toLowerCase().includes(loanDateFrom) ||
        // item.loanDateTo.toString().toLowerCase().includes(loanDateTo) ||
        item.status.toString().toLowerCase().includes(searchTextLower)
      );
  ...
  }, [loanList, searchText, startDate, endDate]);
        ...
        <div className="md:container md:mx-auto md:px-12 px-2">
          ...
          <div className="overflow-x-auto  shadow-lg rounded">
            <table className="table table-base">
              ...
              <tbody>
                {
                  (loanList && currentPosts).map((item, index) => <tr key={item.id}
                    className={`${index % 2 == 1
