...
function Profile() {
    return (
        <>
            ...
            <div className='content-wrap font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover'>
                ...
                <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                    ...
                    >
                        <div className="p-4 md:p-12 text-center lg:text-left">
                            ...
                            <div
                                ...
                                style={{
                                    backgroundImage: 'url("https://images.unsplash.com/photo-1464863979621-258859e62245?q=80&w=1372&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")'
                                }}
                            />
                            ...
                            <div className="pt-12 pb-8">
                                <button className="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full" onClick={() => document.getElementById('my_modal_3').showModal()}>
                                    Change Password
                                </button>
                                <ChangePassword />
                            </div>
                    ...
                    <div className="w-full lg:w-2/5">
                        ...
                        <img
                            src="https://images.unsplash.com/photo-1464863979621-258859e62245?q=80&w=1372&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
